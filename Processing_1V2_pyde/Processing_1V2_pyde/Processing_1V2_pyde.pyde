def setup():
 fullScreen()
 global font, turn, P_energy, P_health, P_block, M_energy, M_health, M_block, M_corruption, M_poison, M_fire, P_poison, P_corruption, P_fire, damage, block, piercing, corruption, poison, fire, img_attack_5, img_attack_8, img_block_5, img_block_10, img_piercing, img_cleanse, img_corruption, img_fireball, img_heal, img_magic_missile, img_poison
...
def draw():
 global message, font, turn, P_energy, P_health, P_block, M_energy, M_health, M_block, damage, block, piercing, corruption, poison, fire, img_attack_5, img_attack_8, img_block_5, img_block_10, img_piercing, img_cleanse, img_corruption, img_fireball, img_heal, img_magic_missile, img_poison
 background(0,0,0)
 textFont(font)
 fill(256,256,256)
 textSize(50)
